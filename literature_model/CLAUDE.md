# Literature Platform — Mineral Processing Pipeline

## Project Objective
Extract data from mineral processing plant PDFs (text, images, process flow diagrams). Store structured results and use them to produce accurate process design flowsheets with parent/child stage nodes, equipment details, and cell counts.
...
## Git / Commits
- Never include "Co-Authored-By" or any reference to Claude/AI in commit messages
